<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Olvido_Contraseña.aspx.vb" Inherits="SIASTV.Olvido_Contraseña" %>
				...
				<div class="agile-row">
					...
					<div class="login-agileits-top"> 	
						<form id="form1" runat="server">
							<p>Nª Cedula</p>
                            <p>&nbsp;<asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" ForeColor="White"></asp:TextBox>
                            </p>
							<p class="auto-style1">
							&nbsp;</p>
                            <p>Correo Electronico</p>
                            <p>
                                <asp:TextBox ID="TextBox2" runat="server" Font-Bold="True" ForeColor="White"></asp:TextBox>
                            </p><br />
							<asp:Button ID="Button1" runat="server" Text="Enviar Peticion" />
&nbsp;</form>
					</div> 
